...
export default function Courses() {
  ...
  const [courses] = useState([
    { id: 1, title: 'Flutter App Development with AI', description: 'Flutter, Dart, Firebase, Riverpod, State Builders, Operators, Animation...', duration: '6 months', image: 'https://media.istockphoto.com/id/1488105061/photo/the-power-of-ai-transforming-industries-and-customer-service-a-look-into-the-future-yellow-ai.webp?a=1&b=1&s=612x612&w=0&k=20&c=SFHSTHDJvSdl_bgVKSfb6qiGuAisPUQ_8Iwb-eFVi24=', status: 'Open', category: 'Development', location: 'Karachi' },
    { id: 2, title: 'IT Professional', description: 'A comprehensive program for computer and IT professionals.', duration: '6 months', image: 'https://images.unsplash.com/photo-1570717173024-ec8081c8f8e9?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8SVQlMjBQcm9mZXNzaW9uYWx8ZW58MHx8MHx8fDA%3D', status: 'Open', category: 'Networking', location: 'Islamabad' },
    { id: 3, title: 'AI & Chatbot Development', description: 'Build cutting edge applications using AI, automation, Amazon...', duration: '4 months', image: 'https://plus.unsplash.com/premium_photo-1725907643701-9ba38affe7bb?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8QUklMjAlMjYlMjBDaGF0Ym90JTIwRGV2ZWxvcG1lbnR8ZW58MHx8MHx8fDA%3D', status: 'Open', category: 'Development', location: 'Lahore' },
    { id: 4, title: 'Python Programming', description: 'An introduction to programming and the Python language is provided in...', duration: '4 months', image: 'https://media.istockphoto.com/id/2192134048/photo/python-programming-language-concept-with-computer-code-and-laptop.webp?a=1&b=1&s=612x612&w=0&k=20&c=AX1ukBoJi_qPGuun3YTOLSCheXgTlJQpihpblwhWdgw=', status: 'Open', category: 'Development', location: 'Karachi' },
    { id: 5, title: 'CCTV Camera Installation', description: 'CCTV Installation training covering wiring, configuration, and monitoring.', duration: '3 months', image: 'https://plus.unsplash.com/premium_photo-1749255441531-8ff03d84d2ea?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8Q0NUViUyMENhbWVyYSUyMEluc3RhbGxhdGlvbnxlbnwwfHwwfHx8MA%3D%3D', status: 'Closed', category: 'Vocational Training Courses', location: 'Karachi' },
    { id: 6, title: 'Generative AI & Chatbot', description: 'Learn to create, run, and build ChatGPT-like Chatbots using AI, Data Flow, Meta, Slack, Alexa, Apps, Google DR.', duration: '4 months', image:'https://media.istockphoto.com/id/2209883565/photo/geo-generative-engine-optimization-concept-businessmen-use-agentic-ai-icons-on-websites-to.webp?a=1&b=1&s=612x612&w=0&k=20&c=NftPwaXRnQ2T3M72PapIkfNuZEP4M8YgvAQbHzN4sp4=', status: 'Open', category: 'Development', location: 'Islamabad' },
    { id: 7, title: 'Graphic Designing', description: 'Master Adobe Photoshop, Illustrator, Figma and visual communication.', duration: '3 months', image: 'https://images.unsplash.com/photo-1608377205656-a5a7ac5777d2?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTl8fEdyYXBoaWMlMjBEZXNpZ25pbmd8ZW58MHx8MHx8fDA%3D', status: 'Open', category: 'Designing', location: 'Karachi' },
    { id: 8, title: 'Cyber Security', description: 'Enterprise network security concepts for implementing security protocols.', duration: '4 months', image: 'https://images.unsplash.com/photo-1620825937374-87fc7d6bddc2?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8Q3liZXIlMjBTZWN1cml0eXxlbnwwfHwwfHx8MA%3D%3D', status: 'Open', category: 'Networking', location: 'Lahore' },
    { id: 9, title: 'Video Animation', description: 'The video editor is responsible for adding effects, transitions, formats...', duration: '3 months', image: 'https://images.unsplash.com/photo-1682506456442-a051e8dae813?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8dmlkZW8lMjBhbmltYXRpb258ZW58MHx8MHx8fDA%3D', status: 'Open', category: 'Designing', location: 'Karachi' },
  ]);
